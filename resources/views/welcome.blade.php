...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="">
            <li class=""><a href="/"><i class="feather icon-home"></i><span class="" data-i18n="Dashboard" id="1" >القائمه الرئيسية</span></a>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="name" class="form-control" name="fname-icon" placeholder="اسم العميل">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="position-relative has-icon-left">
                                            <input type="email" id="email" class="form-control" name="email-id-icon" placeholder="البريد الالكتروني">
                                            <div class="form-control-position">
                            ...
                            <div class="col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="position-relative has-icon-left">
                                            <input type="text" id="adress" class="form-control" name="contact-icon" placeholder="العنوان">
                                            <div class="form-control-position">
            ...
            jQuery.ajax({
                ...
                success: function(result){
                    if (result.success == true) {
                        ...
                        alert("حدث خطاء اثناء اضافه العميل الرجاء المحاوله مره اخري ");
                        window.location.href = '/';
                    }
